...
*/
count(transaction_id) over (partition by user_id order by date(date) range between interval '7' day preceding and interval '1' day preceding) as txn_count_last_7_days
